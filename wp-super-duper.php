...
//					});
		...
		public function block() {
			...
			if ( isset( $this->options['block-api-version'] ) && (int) $this->options['block-api-version'] > 0 ) {
				$block_api_version = (int) $this->options['block-api-version'];
			}
...
jQuery(function() {
				...
				(function (blocksx, elementx, blockEditor) {
					...
					registerBlockType('<?php echo str_replace( "_", "-", sanitize_title_with_dashes( $this->options['textdomain'] ) . '/' . sanitize_title_with_dashes( $this->options['class_name'] ) );  ?>', { // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
						apiVersion: <?php echo (int) $block_api_version; ?>,
